...
- Récupérer le fichier intitulé `2020_LoL_esports_match_data.csv` sur le repertoire partagé et le charger dans un dataframe (rappel : fonction `read_csv`)
...
```{r maxcor2, echo=FALSE, eval=FALSE}
...
```{r mincor2, echo=FALSE, eval=FALSE}
matcor <-  cor(match_data_num)
# on ne considère qu'une moitié de la matrice , sans la diagonale
matcor[upper.tri(matcor)] <-  NA
diag(matcor) <-  NA
...
```{r plotmincor, echo=FALSE, eval=FALSE}
...
```{r matbool2, cache=TRUE,echo=FALSE, eval=FALSE}
...
```{r reglin,echo=FALSE, eval=FALSE}
matcor <-  cor(match_data_num)
# on ne considère qu'une moitié de la matrice , sans la diagonale
matcor[upper.tri(matcor)] <-  NA
diag(matcor) <-  NA
...
```{r reglin3,echo=FALSE, eval=FALSE}
